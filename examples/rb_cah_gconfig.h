 ...
 *  相关编译信息
 *******************************************************************************/
#define PROJECT_NAME       "CAH"

/* 版本信息 */
#define LIB_VERSION        "cas-v1.10"

/* md5 信息 */
#define LIB_COMMIT_MD5     "3990326"

/* 编译日期和时间 */
#define BUILD_DATETIME     "2025-09-10 07:52:29"
...
#define MODEL_PREFIX        cah_20220928
#define NCNN_PARAM_ID_SPACE cah_20220928_ncnn_param_id
#define NCNN_PARAM_MEM      cah_20220928_ncnn_param_bin /* ncnn_param_bin */
#define NCNN_BIN_MEM        cah_20220928_ncnn_bin /* ncnn_bin */

/*******************************************************************************
 *  RKNN 网络模型参数
 *******************************************************************************/
#define MODEL_NAME          "models/cah.rknn"

/* 目标类别数 */
#define OBJ_CLASS_NUM       2

/* 候选框大小 */
#define PROP_BOX_SIZE      (5 + 2)
